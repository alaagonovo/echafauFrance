      ...
      <div
        className={`${
          activeCard === review.id
            ...
            : index === 1
            ? activeCard === "3"
              ? "bg-[var(--review-semidark-color)]"
              : "bg-[var(--review-semilight-color)]"
            : index === 2
            ? activeCard === "3"
              ? "bg-[var(--review-semilight-color)]"
              : "bg-[var(--review-semidark-color)]"
            : "bg-[var(--review-dark-color)]"
        } w-full h-full`}
      >
        {activeCard !== review.id ? (
          <div
          ...
          >
            ...
            >
              <p
                className={`bg-white py-1 px-4 text-[12px] w-fit font-semibold text-[var(--dark-blue)] rounded-md hidden lg:block ${styles.otherAnimation}`}
              >
                Avis
              </p>
              <h3
                className={`text-[var(--dark-blue)] text-lg lg:text-[22px] w-full lg:max-w-[140px] font-semibold mt-0 lg:mt-6 line-clamp-2 ${styles.otherAnimation}`}
              >
                {review.caption}
                {/* Section {index + 1} */}
              </h3>
          ...
          >
            ...
            >
              <p className="bg-white py-1 px-4 text-[12px] font-semibold text-[var(--review-title-color)] rounded-md w-fit hidden lg:block">
                Avis
              </p>
              <div className="flex flex-col justify-between h-full lg:h-[95%]">
                <div>
                  ...
                  <h1 className="text-[22px] lg:text-[33px] font-semibold text-[var(--main-blue)] mb-3 lg:mb-7">
                    {review.caption}
                  </h1>
                  <p className="text-[18px] leading-8 text-[var(--main-blue)] font-normal max-h-48 sm:max-h-max overflow-hidden">
                    {review.review}
                  </p>
                </div>
                <Reviewer
