  ...
  return (
    ...
    >
      <div className="mt-8 md:mt-16 flex flex-col gap-6 relative">
        <div
          className="h-[80vh] mx-auto bg-gray-100 absolute left-[15%] right-[15%] top-0 bottom-[10%] shadow-md"
          style={{ borderRadius: "25px" }}
        >
          <h1 className="text-5xl font-semibold text-black mt-7 text-center">
