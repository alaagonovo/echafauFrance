...
function MainHero() {
  return (
    <section className="h-[100vh] relative">
      ...
      <Header />
      <div className="w-[94%] lg:max-w-[800px] md:max-w-[700px] mt-10 sm:mt-[5%] m-auto md:ml-12  md:h-[65vh] sm:h-[75vh] h-[65vh] flex flex-col justify-between pr-4 md:px-0">
        <h1 className="text-white font-medium leading-10 sm:leading-14 md:leading-[65px] md:text-5xl sm:text-4xl text-3xl">
          Explorez nos solutions d’échafaudage conçues par des experts.
          Fabriquées pour la solidité et la sécurité.
        </h1>
        <p className="text-[18px] md:text-[22px] font-normal text-white  w-[80%]">
