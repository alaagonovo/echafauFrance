...
function Content() {
  return (
    <div className="w-[94%] lg:max-w-[888px] md:max-w-[700px] absolute -translate-y-1/2 left-[4%] top-[calc(50%+35px)] sm:top-[calc(50%+65px)] h-[65vh] sm:h-[55vh] lg:h-[40vh] flex flex-col justify-between min-h-[320px]">
      <h1 className="text-white leading-12 sm:leading-14 md:leading-[50px] md:text-[40px] sm:text-4xl text-3xl">
