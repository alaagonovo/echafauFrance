...
function Content() {
  return (
    <div className="w-[94%] lg:max-w-[888px] md:max-w-[700px] absolute -translate-y-1/2 left-[4%] top-[calc(50%+45px)] h-[60vh] flex flex-col justify-between min-h-[450px]">
      <h1 className="text-white leading-12 sm:leading-14 md:leading-[65px] md:text-[40px] sm:text-4xl text-3xl">
