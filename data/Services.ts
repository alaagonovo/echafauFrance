const services = [
  {
    icon: "/svgs/scafflding1.svg",
    title: "Échafaudage suspendu",
    paragraph:
  ...
  {
    icon: "/svgs/scafflding3.svg",
    title: "Échafaudage fixe",
    paragraph:
      "Stable et adapté aux projets de longue durée. Il est particulièrement utilisé par les entreprises spécialisées dans la construction, l'installation de fenêtres et la couverture.",
  },
];
